...
function applyMove(z, y, x, role) {
    ...
    log.scrollTop = log.scrollHeight; // Auto-scroll a la jugada más reciente
     ...
     // Actualiza el indicador de última jugada visible en la parte superior (útil en móvil)
    document.getElementById('last-move').innerText = `Última jugada → ${label} (${role}): Z=${z}, Y=${y}, X=${x}`;
...
socket.on('restart_game', () => {
    ...
    document.getElementById('last-move').innerText = ''; // Limpia el indicador de última jugada
